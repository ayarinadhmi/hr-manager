...
@RestController
@RequestMapping("/api/hr-manager-kafka")
public class HrManagerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HrManagerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HrManagerKafkaResource(KafkaProperties kafkaProperties) {
